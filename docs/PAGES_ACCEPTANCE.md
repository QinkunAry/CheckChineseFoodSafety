...
- [ ] 页面能区分逐条官方详情、官方检索/数据页和可能需要入口会话的详情链接；
- [ ] 对没有稳定逐条详情页的来源，页面说明了应使用记录号、日期、企业或产品在官方入口复核；
- [ ] 记录级“复制复核关键词”能复制官方记录号、日期、产品、企业和原产地等辅助定位信息；
- [ ] source URL 能打开官方详情、检索页、数据页或可追溯的官方端点；
