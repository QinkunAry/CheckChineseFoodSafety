...
| Japan CAA / MHLW Recalls | `prototype` | First hosted explicit non-empty candidate review, mixed-origin acceptance, MHLW-only production quality/metadata gate and publishing workflow. |
...
| EU RASFF | `prototype` | Maintainer acceptance of `RASFF_OPERATIONS.md` and one reviewed incremental/correction or removal rehearsal. |
