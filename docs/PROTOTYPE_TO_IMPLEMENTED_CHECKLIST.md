...
| EU RASFF | `prototype` | First hosted status-audit/failure-Issue acceptance, committed-release human review, and an approved incremental rebuild/rollback operating procedure. |
