...
| Taiwan TFDA Border Noncompliance | `prototype` | Corrected 388-record Action batch confirmation, attribution wording, production quality gate and publishing workflow. |
