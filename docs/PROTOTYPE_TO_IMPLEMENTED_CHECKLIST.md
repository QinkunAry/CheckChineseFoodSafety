...
| EU RASFF | `implemented` | 18-record hosted audit passed; operations accepted in `RASFF_OPERATIONS.md`; local/hosted correction, natural-increment and withdrawn-removal rehearsals are complete. |
