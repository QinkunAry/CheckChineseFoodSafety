...
| Japan CAA / MHLW Recalls | `prototype` | Broader fixed live smoke sample set, final PDL attribution wording, reviewed candidate batch, production quality gate, publishing workflow. |
