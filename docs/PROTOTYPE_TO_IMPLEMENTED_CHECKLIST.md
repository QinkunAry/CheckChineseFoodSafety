...
| Taiwan TFDA Border Noncompliance | `prototype` | Food-scope review, manually reviewed candidate batch, attribution wording, production quality gate and publishing workflow. |
