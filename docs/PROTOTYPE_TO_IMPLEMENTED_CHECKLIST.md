...
| EU RASFF | `prototype` | Hosted detail-smoke acceptance, withdrawal/corrigendum and status-recheck policy, broader detail review, final CC BY 4.0 attribution, production gates. |
