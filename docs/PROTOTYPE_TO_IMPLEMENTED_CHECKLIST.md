...
| EU RASFF | `prototype` | 18-record hosted audit passed; maintainer acceptance of `RASFF_OPERATIONS.md` remains. Local/hosted correction, natural-increment and withdrawn-removal rehearsals are complete. |
